...
- Scheduler evidence now has an accepted covenant payout spend in `artifacts/scheduler-covenant-payout-evidence.json`; trigger eligibility, winning-bid selection, and stale/duplicate blocking remain replay/indexer-derived.
