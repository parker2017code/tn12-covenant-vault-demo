...
The durable roadmap and twenty-lane status map are in `docs/ROADMAP_STATE.md`. The operator plan is generated by `npm run project:plan` and written to `artifacts/project-plan.json`.
