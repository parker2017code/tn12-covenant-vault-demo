...
- Payload app state: 28 accepted TN12 JSON wRPC payload events, including two repeatable live DeFi v1 receipts, with REST no-payload evidence preserved as historical.
