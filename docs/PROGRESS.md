...
- Payload app state: 27 accepted TN12 JSON wRPC payload events, including the live DeFi v1 receipt, with REST no-payload evidence preserved as historical.
