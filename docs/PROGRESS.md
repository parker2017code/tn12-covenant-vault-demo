...
3. Batch assurance campaigns: multi-pledge accepted progress, pending progress, release/refund planning.
   ...
   - Evidence: three accepted pledge planner payloads, one accepted release-ready planner payload, and one accepted funding transaction with 45/35/20 TKAS pledge outputs. The release artifact is review-ready but not signed or submitted.
