...
- Fix exact visible defects first. One bad icon, arrow, label, spacing issue, or copy line is exact-defect input first. It does not authorize unrelated design removal. Broader cleanup still applies when the broader page genuinely needs it.
