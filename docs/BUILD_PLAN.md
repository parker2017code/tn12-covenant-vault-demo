...
51. Accept one invoice payload receipt through TN12 JSON wRPC. The public REST submit route accepted a no-payload payment only; the matched payload receipt is `34d5f807c2a6b917458f2d1a3926f5ed49730f44da2c480a53a0236c915afc4e` and is verified by `npm run payload:verify`.
52. Accept two prediction/hedge review payloads through TN12 JSON wRPC: `9f9766567fbe8032804583e48e6e9a1aa70f8bb4fbd30018dd45f32e9c0daca7` for the market-update event and `1d5a3c2404188e62663535692ee575a1cb96a069fa19ea7c67670975078c6f3d` for the review prompt. These are app-state receipts only; they do not trade, settle, custody funds, or price a market.
