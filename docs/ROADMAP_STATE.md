...
| 3. Batch assurance | Accepted TN12 payload state plus custody gate | Campaign planner with accepted pledge planner records, signed-only progress, below-minimum review, release-ready planner event, blocked custody draft review, exact pledge-output requirements, wallet-reviewable pledge-output funding/import plan, bounded custody-import validator, and signed-not-broadcast 45/35/20 TKAS pledge funding draft | Submit the reviewed pledge-output draft, then import accepted outpoints |
