...
| 2 | Build the next partial experiment as one vertical slice. | Coordination League or Scheduler Duel gets one artifact, one visible row, and one focused test. | No |
