...
- Coordination covenant-release update, 2026-05-12: fresh `AssurancePledge` covenant pledge funding `314ddccb993892c8bed919590f8675d2d3e208060a3c3b32300d4e4da30464fc` is accepted with three covenant-bound pledge outputs, and accepted release spends `9a3350f9c11dc9b130a76377e8ffca091f6d38cd00824306a730b6946e181977`, `0a9efe559aa2e96a02e5571ee0ed76bfe329c61275fa6a7575446d271f765aab`, and `954d5aa0b17ab15fc503da769e423ecace4164a8a888d625d6ab07f2e2813a79` are recorded in `artifacts/coordination-covenant-release-evidence.json`. Threshold selection remains replay/planner evidence.
...
- Scheduler covenant-payout update, 2026-05-12: `artifacts/scheduler-covenant-payout-evidence.json` records accepted covenant funding `a1928dfc9434c71a759a138429dea903cc44f4df7aee61079f9b865dc4a97dab` and accepted guarded payout spend `634873a5a55136d010ba9371c4a90da997755c8a31b7eca458d5f6756eddb986`. `artifacts/scheduler-covenant-settlement-target.json` now points to that accepted spend while trigger eligibility remains replay-derived.
...
| 7 | Keep Scheduler payout review bounded. | Accepted payout spend, local payout rejects, and replay-derived stale/duplicate guards stay visible without calling scheduler eligibility protocol-enforced. | No |
