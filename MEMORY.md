...
- WIP lanes: live wallet connector submit without local keys, batch-assurance custody requirements and matched pledge outputs, durable indexer replay, and attestation reputation/provenance hardening.
