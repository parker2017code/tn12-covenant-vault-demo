...
- Payload state: 36 accepted payload events, including seven DeFi v1 receipts, one scheduler-intent receipt, one scheduler-execution receipt, and one agent release wallet-review event.
