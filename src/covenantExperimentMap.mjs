export function buildCovenantExperimentMap({ generatedAt = new Date().toISOString() } = {}) {
  const experiments = [
    ...
    experiment({
      ...
      plainPoint: "The useful story has two parts: the good spend works, and the obvious bad spends fail.",
    ...
    experiment({
      ...
      cryptoPoint: "Public evidence lets reviewers check the refund/release paths. The campaign operator's database is secondary.",
