...
assert.equal(provenStatus.acceptedEvidence.checkpointRecords, 48);
assert.equal(provenStatus.acceptedEvidence.payloadEvents, 35);
...
assert.equal(operatorReceiptPack.evidence.checkpointRecords, 48);
assert.equal(operatorReceiptPack.evidence.payloadEvents, 35);
