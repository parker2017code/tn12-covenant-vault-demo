...
assert.match(html, /Product maps, wallet drafts, pool-style reducers, scheduler work, and generated artifact inventories live in Lab Tools/);
...
assert.match(html, /payload alone is not custody settlement/i);
...
assert.match(html, /wallet drafts, pool-style reducers, scheduler work/);
