...
assert.match(html, /Product maps, wallet drafts, DeFi reducers, scheduler work, and generated artifact inventories live in Lab Tools/);
...
assert.match(html, /The detailed app categories stay out of the default proof path/);
...
assert.match(html, /wallet drafts, DeFi reducers, scheduler work/);
