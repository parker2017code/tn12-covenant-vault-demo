...
const walletStandardRequests = JSON.parse(await readFile(process.env.WALLET_STANDARD_REQUESTS || "artifacts/wallet-standard-requests.json", "utf8"));
...
const plan = buildNextTenExecutionPlan({
  queue,
  walletMapping,
