...
try {
  ...
  await expectText(page, "#indexer-persistence", "live-window-overlaps-checkpoint");
  ...
  await expectText(page, "#auction-list", "Auction custody review");
  await expectText(page, "#auction-list", "auction-custody-review-ready");
  await expectText(page, "#auction-list", "0 custody-ready");
  ...
  await expectText(page, "#agent-list", "Agent settlement review");
  await expectText(page, "#agent-list", "agent-settlement-review-ready");
  await expectText(page, "#agent-list", "0 custody-ready");
