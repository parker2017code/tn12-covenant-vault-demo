...
const rustSource = "scripts/rust/blitz_mux_worker_return_draft.rs";
const outPath = process.env.OUT || "artifacts/signed-drafts/blitz-mux-worker-a-return.json";
...
const tmp = await mkdtempCompat("tn12-blitz-mux-worker-return-");
try {
  ...
  const artifact = {
    schema: "tn12-blitz-mux-worker-return-draft/v1",
...
function cargoToml(root) {
  return `[package]
name = "tn12-blitz-mux-worker-return-draft"
version = "0.1.0"
edition = "2024"
