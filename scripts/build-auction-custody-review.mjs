...
const custodySourcesPath = process.env.AUCTION_CUSTODY_SOURCES || "fixtures/AuctionCustodySources.json";
...
const review = buildAuctionCustodyReview({ settlementDrafts, walletStandardMapping, custodySources });
