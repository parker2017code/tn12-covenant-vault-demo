...
const standardRequests = JSON.parse(await readFile(process.env.WALLET_STANDARD_REQUESTS || "artifacts/wallet-standard-requests.json", "utf8"));
const outPath = process.env.OUT || "artifacts/wallet-connector-implementation-slice.json";

const slice = buildWalletConnectorImplementationSlice({ walletMapping, unsignedTemplates, standardRequests });
