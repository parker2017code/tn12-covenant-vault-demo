...
const [workbench, intentRegistry, binding, payoutEvidence, checkedIn] = await Promise.all([
...
assert.ok(artifact.nextTn12Run.some((item) => /negative payout candidates/.test(item)));
